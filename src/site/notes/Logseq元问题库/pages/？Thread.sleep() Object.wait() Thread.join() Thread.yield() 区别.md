---
{"dg-publish":true,"permalink":"/Logseq元问题库/pages/？Thread.sleep() Object.wait() Thread.join() Thread.yield() 区别/","dgPassFrontmatter":true}
---

？[[Logseq元知识库/pages/Thread.sleep()\|Thread.sleep()]] [[Logseq元知识库/pages/Object.wait()\|Object.wait()]] [[Logseq元知识库/pages/Thread.join()\|Thread.join()]] [[Logseq元知识库/pages/Thread.yield()\|Thread.yield()]] 区别
>
``` dataviewjs
