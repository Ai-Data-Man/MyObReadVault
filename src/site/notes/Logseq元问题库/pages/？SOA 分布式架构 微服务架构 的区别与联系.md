---
{"dg-publish":true,"permalink":"/Logseq元问题库/pages/？SOA 分布式架构 微服务架构 的区别与联系/","dgPassFrontmatter":true}
---

？[[Logseq元知识库/pages/SOA\|SOA]] [[Logseq元知识库/pages/分布式架构\|分布式架构]] [[Logseq元知识库/pages/微服务架构\|微服务架构]] 的区别与联系
>
``` dataviewjs
