---
{"dg-publish":true,"permalink":"/Logseq元问题库/pages/？Ngix 和 SpringCloud.GateWay作网关的区别/","dgPassFrontmatter":true}
---

？[[Logseq元知识库/pages/Ngix\|Ngix]] 和 [[Logseq元知识库/pages/SpringCloud.GateWay\|SpringCloud.GateWay]]作网关的区别
>
``` dataviewjs
