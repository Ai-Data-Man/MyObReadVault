---
{"Aliases":["#JTA"],"dg-publish":true,"permalink":"/Logseq元知识库/pages/JTA/","dgPassFrontmatter":true}
---
...
> 
>
> 日本越洋航空（Japan Transocean Air），日本的一家航空公司。
>
> Java事务API（Java Transaction API），Java平台上的处理事务的应用程序接口。
>
> [Wikipedia](https://zh.wikipedia.org/wiki/JTA)
>
``` dataviewjs
