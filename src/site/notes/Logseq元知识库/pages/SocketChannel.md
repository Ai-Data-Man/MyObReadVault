---
{"Aliases":["#SocketChannel"],"dg-publish":true,"permalink":"/Logseq元知识库/pages/SocketChannel/","dgPassFrontmatter":true}
---

？基于[[Logseq元问题库/pages/？JDK NIO Api\|？JDK NIO Api]]实现单线程[[Logseq元知识库/pages/NIO\|NIO]]
>
``` dataviewjs
