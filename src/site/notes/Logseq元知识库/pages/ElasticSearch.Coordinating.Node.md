---
{"Aliases":["#ElasticSearch/Coordinating/Node"],"dg-publish":true,"permalink":"/Logseq元知识库/pages/ElasticSearch.Coordinating.Node/","dgPassFrontmatter":true}
---
...
function iter(block, level) {
	...
	if (!blockObj["symbol"]) {
		...
		if (level != 0) {
			blockObj["text"] = blockObj["text"] + " <mark style=\"background: #BBFABBA6;\">add by " + 
block.link + "<\/mark>"
		} 
